 ...
 */
package ai.samepage.common.core.exception;
...
public class StateCodeException extends RuntimeException {
    ...
    public StateCodeException(Integer stateCode) {
        this(stateCode, DEFAULT.getDesc());
    }

    public StateCodeException(Integer stateCode, String message) {
        this(stateCode, message, null);
    }

    public StateCodeException(Integer stateCode, String message, Throwable cause) {
        super(message, cause);
    ...
    public StateCodeException(Integer stateCode, boolean writableStackTrace) {
        this(stateCode, DEFAULT.getDesc(), null, true, writableStackTrace);
    }

    public StateCodeException(Integer stateCode, String message, boolean writableStackTrace) {
        this(stateCode, message, null, true, writableStackTrace);
    }

    protected StateCodeException(Integer stateCode, String message, Throwable cause, boolean writableStackTrace) {
        this(stateCode, message, cause, true, writableStackTrace);
    }

    protected StateCodeException(Integer stateCode, String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
