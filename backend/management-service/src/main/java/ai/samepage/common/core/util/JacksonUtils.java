 ...
 */
package ai.samepage.common.core.util;
...
public class JacksonUtils {
     ...
     * @param obj 需要序列化的对象
     * @return 转换后的字符串
     * @throws UtilException 序列化异常时抛出
     */
    public static String writeValueAsString(Object obj) {
        try {
            return OBJECT_MAPPER.writeValueAsString(obj);
        } catch (JsonProcessingException e) {
            throw new UtilException("序列化发生错误！", e);
        }
    }
    ...
    public static <T> T readValue(String json, Class<T> cls) {
        try {
            ...
            throw new UtilException("序列化异常！", e);
        }
    }
     ...
     * @throws UtilException 序列化异常时抛出
     */
    public static <T> List<T> readValueAsList(String json, Class<T> cls) {
