 ...
 */
package ai.samepage.common.core.resp;
...
public class RespBody<T> {
    ...
    public RespBody(Integer statusCode, String message, T data) {
        this.statusCode = statusCode;
        this.message = message;
        this.data = data;
    }
    ...
    public static RespBody<ErrorBody> error(Integer code, String message, ErrorBody errorBody) {
     ...
     * @param body      返回数据体
     */
    public static <T> RespBody<T> build(Integer stateCode, String message, T body) {
