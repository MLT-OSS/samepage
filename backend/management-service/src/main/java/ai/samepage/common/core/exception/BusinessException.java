...
import ai.samepage.common.core.resp.ResultCode;
...
public class BusinessException extends StateCodeException {
    ...
    public BusinessException(ResultCode resultCode, String message) {
        this(resultCode.getCode(), message, null, false);
    }
    ...
    public BusinessException(Integer code, String message, Serializable data, boolean writableStackTrace) {
