...
const mockUrl_7_0_0_0 = 'mock/858' as any;
...
type PostTenantRegisterRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/tenant/register', 'data', string, string, false>
>;
...
type PostTenantUserRegisterRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/tenant/user/register', 'data', string, string, false>
>;
...
type GetTenantCheckRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/tenant/check', 'data', string, 'tenantName', false>
>;
...
type PostTenantUserChangeRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/tenant/user/change', 'data', string, string, false>
>;
...
const mockUrl_7_0_1_0 = 'mock/858' as any;
...
type PostInternalInviteLinkRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/internal/invite/link', 'data', string, string, false>
>;
...
type PostInternalInviteCodeRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/internal/invite/code', 'data', string, string, false>
>;
