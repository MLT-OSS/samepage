...
const mockUrl_0_0_0_0 = 'mock/858' as any;
...
type PostPromptsRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/prompts', 'data', string, string, false>
>;
...
type DeletePromptsIdRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/prompts/{id}', 'data', 'id', string, false>
>;
...
type PostPromptsEnterpriseUpdateRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/prompts/enterprise/update', 'data', string, string, false>
>;
...
type PostPromptsTypeSearchRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/prompts/{type}/search', 'data', 'type', string, false>
>;
...
type GetPromptsCountRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/prompts/count', 'data', string, string, true>
>;
