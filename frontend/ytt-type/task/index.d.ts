...
const mockUrl_4_0_0_0 = 'https://yapi.mlamp.cn/mock/858' as any;
...
type GetTaskInfoRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/task/info', 'data', string, 'taskId', false>
>;
...
type PostTaskCreateRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/task/create', 'data', string, string, false>
>;
...
type GetTaskCancelRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/task/cancel', 'data', string, 'taskId', false>
>;
