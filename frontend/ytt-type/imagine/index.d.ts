...
const mockUrl_5_0_0_0 = 'https://yapi.mlamp.cn/mock/858' as any;
...
type PostImagineMessageRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/imagine/message', 'data', string, string, false>
>;
...
type PostImagineMessageChangeRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/imagine/message/change', 'data', string, string, false>
>;
...
type PostImagineSettingRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/imagine/setting', 'data', string, string, false>
>;
...
type GetImagineSettingRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/imagine/setting', 'data', string, string, true>
>;
...
type PostImagineCallbackRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/imagine/callback', 'data', string, string, true>
>;
...
type PostTranslateRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/translate', 'data', string, string, false>
>;
...
type GetImagineConfigRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/imagine/config', 'data', string, string, true>
>;
...
type PostImagineUploadRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/imagine/upload', 'data', string, string, false>
>;
...
type GetImagineDownloadRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/imagine/download', 'data', string, 'key', false>
>;
