...
const mockUrl_6_0_2_0 = 'https://yapi.mlamp.cn/mock/858' as any;
...
type GetDictBotRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/dict/bot', 'data', string, string, true>
>;
...
const mockUrl_6_0_0_0 = 'https://yapi.mlamp.cn/mock/858' as any;
...
type GetBotSidebarRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/bot/sidebar', 'data', string, string, true>
>;
...
type GetBotKeyWelcomeRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/bot/{key}/welcome', 'data', 'key', string, false>
>;
...
type GetBotFixedKeyRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/bot/fixed/{key}', 'data', 'key', 'fixed', false>
>;
...
const mockUrl_6_0_1_0 = 'https://yapi.mlamp.cn/mock/858' as any;
...
type PostBotTemplateKeyConvRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/bot/template/{key}/conv', 'data', 'key', string, false>
>;
...
type GetBotTemplateKeyParamsRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/bot/template/{key}/params', 'data', 'key', string, false>
>;
...
type PostBotTemplateKeyCheckRequestConfig = Readonly<
    RequestConfig<'https://yapi.mlamp.cn/mock/858', '', '', '/bot/template/{key}/check', 'data', 'key', string, false>
>;
