...
const mockUrl_2_0_0_0 = 'mock/858' as any;
...
type GetUserProfileRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/user/profile', 'data', string, string, true>
>;
...
type GetUserProfileSettingsRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/user/profile/settings', 'data', string, string, true>
>;
...
type PostUserTranslateSettingRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/user/translateSetting', 'data', string, string, false>
>;
...
type GetUserTranslateSettingRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/user/translateSetting', 'data', string, 'url', false>
>;
...
type GetUserAuditTenantRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/user/audit/tenant', 'data', string, string, true>
>;
...
const mockUrl_2_0_1_0 = 'mock/858' as any;
...
type GetCorpDepartmentRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/corp/department', 'data', string, 'corpId', false>
>;
...
type PostCorpUserRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/corp/user', 'data', string, string, false>
>;
...
type GetServiceChangelogTypeRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/service/changelog/{type}', 'data', 'type', string, false>
>;
