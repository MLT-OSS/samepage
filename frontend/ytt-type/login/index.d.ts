...
const mockUrl_1_0_0_0 = 'mock/858' as any;
...
type PostCodeSmsAccountRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/code/sms/account', 'data', string, string, false>
>;
...
type PostSignupRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/signup', 'data', string, string, false>
>;
...
type PostLoginRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/login', 'data', string, string, false>
>;
...
type GetCheckAccountRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/check/account', 'data', string, 'account', false>
>;
...
type PostLogoutRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/logout', 'data', string, string, false>
>;
...
type PostResetPasswordRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/reset-password', 'data', string, string, false>
>;
...
type PostUserTokenRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/user/token', 'data', string, string, false>
>;
...
type PostCorpSignupRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/corp/signup', 'data', string, string, false>
>;
