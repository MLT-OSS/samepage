...
const mockUrl_3_0_0_0 = 'mock/858' as any;
...
type GetDocInfoRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/doc/info', 'data', string, 'docId', false>
>;
...
type GetDocListRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/doc/list', 'data', string, string, true>
>;
...
type DeleteDocDocIdRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/doc/{docId}', 'data', 'docId', string, false>
>;
...
type PostDocUploadConfigRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/doc/upload-config', 'data', string, string, false>
>;
...
const mockUrl_3_0_1_0 = 'mock/858' as any;
...
type PostBotChatKeyConvRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/bot/chat/{key}/conv', 'data', 'key', string, false>
>;
...
type PostBotChatKeyCheckTextRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/bot/chat/{key}/check/text', 'data', 'key', string, false>
>;
...
const mockUrl_3_0_2_0 = 'mock/858' as any;
...
type PostBotConvKeyFeedbackRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/bot/conv/{key}/feedback', 'data', 'key', string, false>
>;
...
type GetBotConvKeyRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/bot/conv/{key}', 'data', 'key', 'all' | 'convId', false>
>;
...
type PostBotConvKeyInfoRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/bot/conv/{key}/info', 'data', 'key', string, false>
>;
...
type PostBotConvKeyMsgRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/bot/conv/{key}/msg', 'data', 'key', string, false>
>;
...
type PostBotStreamConvKeyMsgRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/bot/stream/conv/{key}/msg', 'data', 'key', string, false>
>;
...
type PostBotConvKeyStopRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/bot/conv/{key}/stop', 'data', 'key', string, false>
>;
...
type PostBotKeyCheckRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/bot/{key}/check', 'data', 'key', string, false>
>;
...
type PostBotConvUploadExistsRequestConfig = Readonly<
    RequestConfig<'mock/858', '', '', '/bot/conv/upload/exists', 'data', string, string, false>
>;
